          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <!-- Current: "bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
               ...
               <x-nav-link href="/home" :active="request()-> is('home')">Hom</x-nav-link>
               <x-nav-link href="/students" :active="request()-> is('students')">STooooooooodunt</x-nav-link>
               <x-nav-link href="/guardian" :active="request()-> is('guardian')">Parents</x-nav-link>
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                ...
                <img src="https://static.wikitide.net/bluearchivewiki/a/a2/Hare_%28Camping%29.png" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
              </button>
